! function(t) {
    ...
    var r, o, i;
    r = document, o = t(0), i = t(2), (t = r.createElement("script")).async = !0, i.setVersion("c4ef6d39"), o.isInRampPercentage(o.LIST.SEND_LOGS.chance) && (t.onerror = function() {
        i.error("Failed to load ".concat("c4ef6d39"), new Error("failed to load main.js"))
    }), t.src = "https://s.pinimg.com/ct/lib/main.c4ef6d39.js", (o = r.getElementsByTagName("script")[0]).parentNode.insertBefore(t, o)
}, function(n, e, t) {
    var r = t(0),
        o = {},
        i = "unknown";
