var pJS = function(e, a) {
    ...
    a && Object.deepExtend(i, a), i.tmp.obj = {
        ...
        var a = i.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(a, t, i, s) {
            ...
            s = window.URL || window.WinkitURL || window,
...
Object.deepExtend = function(e, a) {
    ...
    return e
}, window.requestAnimFrame = window.requestAnimationFrame || window.WinkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
    window.setTimeout(e, 1e3 / 60)
}, window.cancelRequestAnimFrame = window.cancelAnimationFrame || window.WinkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout, window.pJSDom = [], window.particlesJS = function(e, a) {
